...
📊 Elasticsearch is a distributed, RESTful search and analytics engine built on Apache Lucene. Shay Banon created its precursor, Compass, in 2004, and released the first version of Elasticsearch on February 8, 2010, describing it as "You Know, for Search."
...
📊 In March 2010, the Apache Solr search server joined Lucene as a sub-project, merging the two developer communities.
...
📊 Apache Lucene version 4.0 was released on October 12, 2012, introducing major features such as pluggable codecs and near-real-time search improvements.
...
📜 Java EE 7, released on May 28, 2013, added support for WebSocket, JSON processing, and HTML5, modernizing the platform for the web.
...
🔐 Let's Encrypt is a non-profit certificate authority run by Internet Security Research Group (ISRG) that provides X.509 certificates for Transport Layer Security (TLS) encryption at no charge. Let's Encrypt was announced publicly on November 18, 2014.
