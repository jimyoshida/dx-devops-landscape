...
📊 The project was officially renamed PostgreSQL in 1996 to reflect its SQL support, with the release of version 6.0 reset to continue the sequence from the original Berkeley POSTGRES project.
