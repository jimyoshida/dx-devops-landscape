...
🧠 Google Antigravity platform was announced on November 18, 2025, alongside the release of Gemini 3, representing Google's entry into AI-powered development tools as an AI agent-first IDE heavily modified from Visual Studio Code.
